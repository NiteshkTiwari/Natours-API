...
var bookTour = function bookTour(_x) {
  return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51NxACySDsxIySLBtIlLTb8mIApUFAIOkjODHtchatKZla3JImTNK8ntAxJW48CyXDrqbtB1L4uY1VEDzwdHjcJwS00ILn1emi2');
          _context.prev = 1;
          _context.next = 4;
...
if (fileInput) fileInput.addEventListener('change', function (_x2) {
